...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.h_rect = rg.Rectangle(rg.Point((self.center.x - (0.5*self.width)),self.center.y - self.thickness), rg.Point((self.center.x + (0.5*self.width)),self.center.y))
        self.v_rect = rg.Rectangle(rg.Point(self.center.x - 0.5*self.thickness ,self.center.y), rg.Point((self.center.x + 0.5*self.thickness),(self.center.y + self.height)))
